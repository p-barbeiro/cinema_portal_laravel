...
datePickerCalculateDays();" v-cloak>
    <div class="sm:ml-5 ">
        <div class="w-auto ">
            <label for="datepicker" class="block font-medium text-sm text-gray-700 dark:text-gray-300">Select
                Date</label>
            <div class="relative sm:min-w-[17rem] w-full">
                <input id=datepicker name={{$name}} x-ref="datePickerInput" type="text" @click="datePickerOpen=!datePickerOpen"
...
disabled:select-none" placeholder="Any date" readonly/>
                        ...
                        <template x-for="(day, dayIndex) in datePickerDaysInMonth" :key="dayIndex">
                            <div class="px-0.5 mb-1 aspect-square">
                                <div
                                    ...
                                    class="{
'bg-blue-300': datePickerIsToday(day) == true,
