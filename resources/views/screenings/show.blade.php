                ...
                <section>
                    <div class="flex flex-col md:flex-row space-y-4 md:space-y-0 p-3 bg-gray-50 border dark:bg-gray-900 rounded-lg shadow-lg">
                        <div class="md:w-1/6">
                            ...
                            @else
                                <div class="flex items-center justify-center bg-gray-200 dark:bg-gray-700 rounded-lg w-full h-full">
                        ...
                        <div class="md:w-5/6 md:pl-6 space-y-3">
                            ...
                            <div class="flex items-center text-lg text-gray-700 dark:text-gray-300 space-x-2 font-semibold">
