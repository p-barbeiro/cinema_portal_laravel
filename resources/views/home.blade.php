    ...
    <main>
        <div class="max-w-7xl mx-auto py-4 sm:px-6 lg:px-8">
            <div class="my-6 p-8 bg-white dark:bg-gray-900 overflow-hidden shadow-lg sm:rounded-lg text-gray-900 dark:text-gray-50">
                <h3 class="font-extrabold text-2xl text-gray-800 dark:text-gray-200 leading-tight text-center">
                ...
                <p class="py-3 font-medium text-md text-gray-700 dark:text-gray-300 text-justify">
                ...
                <p class="py-3 font-medium text-md text-gray-700 dark:text-gray-300 text-justify">
                    <a href="{{ route('register') }}" class="text-red-600 hover:text-red-800 font-semibold">Sign up</a> for our newsletter to stay updated on the latest releases, special screenings, and <span class="text-red-600 font-semibold">ticket discounts</span>. At Cinemagic, every movie is a magical experience waiting to unfold.
                </p>
            </div>
        </div>
    </main>
