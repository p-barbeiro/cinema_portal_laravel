    ...
    <main>
        <div class="max-w-7xl mx-auto py-4 sm:px-6 lg:px-8">
            <div class="my-6 p-8 bg-white dark:bg-gray-900 overflow-hidden shadow-lg sm:rounded-lg text-gray-900 dark:text-gray-50">
                <h3 class="font-extrabold text-3xl text-gray-800 dark:text-gray-200 leading-tight text-center">
                ...
                <p class="py-3 font-medium text-xl text-gray-700 dark:text-gray-300 text-justify">
